# Security Playbooks Documentation README

Complete guide to Security Playbooks documentation, resources, and learning materials.

## Getting Started

- [Quick Start](getting-started/quickstart.md) — Set up Security Playbooks in 5 minutes
- [Installation](getting-started/installation.md) — Detailed installation instructions
- [Getting Started Guide](getting-started/getting-started.md) — Complete onboarding guide

## Product Documentation

- [Overview](product/overview.md) — Project overview and purpose
- [What is Security Playbooks?](product/what-is-security-playbooks.md) — Comprehensive project description
- [Features](product/features.md) — Complete feature list and descriptions
