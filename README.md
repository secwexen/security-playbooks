...
**Security Playbooks** is an open-source, cybersecurity educational repository designed for detection engineers, threat hunters, incident responders, cybersecurity professionals and SOC analysts.
