...
- Suricata rules for network threat detection

The goal is to provide structured, testable, and maintainable detection logic for SOC analysts, threat hunters, and blue team engineers.
